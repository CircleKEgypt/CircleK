...
//    {
//        private readonly ILogger<LoginIndexController> _logger;
//        private readonly CkhelperdbContext _dbContext;
//        private static readonly List<Helpersuser> Users = new List<Helpersuser>();
//        public LoginIndexController(ILogger<LoginIndexController> logger, CkhelperdbContext dbContext)
//        {
//            _logger = logger;
...
//        [HttpPost]
//        [ResponseCache(Location = ResponseCacheLocation.None, NoStore = true)]
//        public async Task<IActionResult> LoginIndex(VMLogin modellogin)
//        {
//            if (HttpContext.Request.Query.ContainsKey("preventBack"))
//            {
//                // Clear authentication cookies if any (extra measure)
